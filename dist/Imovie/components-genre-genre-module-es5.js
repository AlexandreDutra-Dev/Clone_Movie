(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-genre-genre-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [{ path: '', component: _genre_component__WEBPACK_IMPORTED_MODULE_3__["GenreComponent"] }];
            var GenreRoutingModule = /** @class */ (function () {
                function GenreRoutingModule() {
                }
                return GenreRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GenreComponent = /** @class */ (function () {
                function GenreComponent(movieService, router) {
                ...
                GenreComponent.prototype.ngOnInit = function () {
                    ...
                    this.router.params.subscribe(function (params) {
                        ...
                        _this.getMoviesGenre(_this.id);
                    });
                };
                GenreComponent.prototype.getMoviesGenre = function (id) {
                    var _this = this;
                    this.movieService.getMoviesByGenre(id).pipe(Object(rxjs_internal_operators_delay__WEBPACK_IMPORTED_MODULE_4__["delay"])(2000)).subscribe(function (res) {
                        _this.moviesGenre = res.results;
                        _this.loader = false;
                    });
                };
...
//# sourceMappingURL=components-genre-genre-module-es5.js.map
//# sourceMappingURL=components-genre-genre-module-es5.js.map