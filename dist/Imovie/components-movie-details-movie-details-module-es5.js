(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-movie-details-movie-details-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppMovieDialogComponent = /** @class */ (function () {
                function AppMovieDialogComponent(dialogRef, data) {
                    this.dialogRef = dialogRef;
                    this.data = data;
                }
                AppMovieDialogComponent.prototype.closeDialog = function () {
                    this.dialogRef.close('movie');
                };
                AppMovieDialogComponent.prototype.ngOnInit = function () {
                };
                return AppMovieDialogComponent;
            }());
            AppMovieDialogComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MovieDetailsRoutingModule = /** @class */ (function () {
                function MovieDetailsRoutingModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MovieDetailsComponent = /** @class */ (function () {
                function MovieDetailsComponent(movieService, router, sanitizer, dialog) {
                ...
                MovieDetailsComponent.prototype.ngOnInit = function () {
                    ...
                    this.router.params.subscribe(function (params) {
                        _this.id = params['id'];
                        _this.getSingleMoviesVideos(_this.id);
                        _this.getSingleMoviesDetails(_this.id);
                        _this.getCast(_this.id);
                        _this.getBackropsImages(_this.id);
                        _this.getRecomendMovie(_this.id);
                    });
                };
                MovieDetailsComponent.prototype.getSingleMoviesDetails = function (id) {
                    var _this = this;
                    this.movieService.getMovie(id).subscribe(function (res) {
                        _this.movie = res;
                    });
                };
                MovieDetailsComponent.prototype.getSingleMoviesVideos = function (id) {
                    var _this = this;
                    this.movieService.getMovieVideos(id).subscribe(function (res) {
                        if (res.results.length) {
                            _this.video = res.results[0];
                            _this.relatedvideo = res.results;
                        }
                    });
                };
                MovieDetailsComponent.prototype.openDialogMovie = function (video) {
                ...
                MovieDetailsComponent.prototype.getCast = function (id) {
                    var _this = this;
                    this.movieService.getMovieCredits(id).subscribe(function (res) {
                        _this.casts = res.cast;
                    });
                };
                MovieDetailsComponent.prototype.getBackropsImages = function (id) {
                    var _this = this;
                    this.movieService.getBackdropsImages(id).subscribe(function (res) {
                        _this.backdrops = res.backdrops;
                    });
                };
                MovieDetailsComponent.prototype.getRecomendMovie = function (id) {
                    var _this = this;
                    this.movieService.getRecomendMovies(id).subscribe(function (res) {
                        _this.recomendMovies = res.results;
                    });
                };
...
//# sourceMappingURL=components-movie-details-movie-details-module-es5.js.map
//# sourceMappingURL=components-movie-details-movie-details-module-es5.js.map