...
const routes = [{ path: '', component: _genre_list_component__WEBPACK_IMPORTED_MODULE_3__["GenreListComponent"] }];
let GenreListRoutingModule = class GenreListRoutingModule {
};
...
let GenreListComponent = class GenreListComponent {
    ...
    MovieGenre() {
        this._movie.getGenres().pipe(Object(rxjs_internal_operators_delay__WEBPACK_IMPORTED_MODULE_3__["delay"])(2000)).subscribe((res) => {
            this.genreslist = res.genres;
            this.loader = false;
        });
    }
};
GenreListComponent.ctorParameters = () => [
...
let GenreListModule = class GenreListModule {
};
