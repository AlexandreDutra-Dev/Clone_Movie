...
const routes = [{ path: '', component: _person_component__WEBPACK_IMPORTED_MODULE_3__["PersonComponent"] }];
...
let PersonComponent = class PersonComponent {
    constructor(movieServices, router) {
    ...
    gerPersonDetails(id) {
        this.movieServices.getPersonDetail(id).subscribe((result) => {
            this.person = result;
        });
    }
