...
const routes = [{ path: '', component: _tv_genre_component__WEBPACK_IMPORTED_MODULE_3__["TvGenreComponent"] }];
let TvGenreRoutingModule = class TvGenreRoutingModule {
};
...
let TvGenreComponent = class TvGenreComponent {
    ...
    getTvByGenre(id) {
        this.tvService.getTVShowByGenre(id).subscribe((res) => {
            this._tv = res.results;
        });
    }
};
TvGenreComponent.ctorParameters = () => [
...
let TvGenreModule = class TvGenreModule {
};
