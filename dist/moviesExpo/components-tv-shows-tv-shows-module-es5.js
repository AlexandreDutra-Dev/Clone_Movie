(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-tv-shows-tv-shows-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TvShowsRoutingModule = /** @class */ (function () {
                function TvShowsRoutingModule() {
                }
                return TvShowsRoutingModule;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TvShowsComponent = /** @class */ (function () {
                function TvShowsComponent(tvService) {
                ...
                TvShowsComponent.prototype.TopRatedTVShows = function (page) {
                    var _this = this;
                    this.tvService.getTopRatedTVShows(page).pipe(Object(rxjs_internal_operators_delay__WEBPACK_IMPORTED_MODULE_3__["delay"])(2000)).subscribe(function (res) {
                        _this.topRatedTv = res.results;
                        _this.totalResults = res.total_results;
                        _this.loader = false;
                    }, function (error) { return console.log(error); });
                };
                TvShowsComponent.prototype.changePage = function (event) {
                    this.TopRatedTVShows(event.pageIndex + 1);
                    this.loader = false;
                };
                TvShowsComponent.prototype.searchMovies = function () {
                    var _this = this;
                    this.tvService.searchtv(this.searchStr).subscribe(function (res) {
                        _this.searchRes = res.results;
                    });
                };
                return TvShowsComponent;
            }());
            TvShowsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TvShowsModule = /** @class */ (function () {
                function TvShowsModule() {
                }
                return TvShowsModule;
            }());
...
//# sourceMappingURL=components-tv-shows-tv-shows-module-es5.js.map
//# sourceMappingURL=components-tv-shows-tv-shows-module-es5.js.map